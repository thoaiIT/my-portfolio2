...
const HomePage = () => {
  ...
  const services = [
    {
      ...
      title: 'Strategy',
      description:
        'Digital strategy that aligns with your business goals and drives growth.',
    ...
    },
    {
      ...
      title: 'Design',
      description:
        'Beautiful, functional designs that captivate users and enhance experiences.',
    ...
    },
    {
      ...
      title: 'Development',
      description:
        'Robust, scalable solutions built with cutting-edge technologies.',
    ...
    },
    {
      ...
      title: 'Marketing',
      description:
        'Data-driven marketing strategies that connect with your audience.',
  ...
  return (
    <div
      ref={heroRef}
      className={`bg-black text-white ${isScrolling ? 'is-scrolling' : ''}`}
    >
      {/* Hero Section */}
        ...
        <div className="w-full max-w-7xl mx-auto">
          ...
          <HeroReveal className="relative z-10" delay={0.5} yOffset={30}>
            <p className="hero-subtitle text-lg md:text-xl text-gray-400 max-w-xl mb-10">
              Creating bold digital solutions that push boundaries and drive
      ...
      <section className="py-24 px-6 md:px-12 lg:px-24 border-t border-gray-900">
        <ViewportReveal className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-400 mb-2">
                <span className="stat-number" data-target="98" data-suffix="%">
                  0
                </span>
              </div>
            ...
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-400 mb-2">
                <span className="stat-number" data-target="15" data-suffix="+">
                  0
                </span>
              </div>
            ...
            <div className="text-center">
              <div className="text-5xl md:text-6xl font-bold text-orange-400 mb-2">
                <span className="stat-number" data-target="8" data-suffix="+">
                  0
                </span>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <ViewportReveal className="mb-16">
            ...
            <p className="reveal-text text-xl text-gray-400 max-w-3xl">
              We offer a full spectrum of digital services to transform your
      ...
      <section className="parallax-section py-24 px-6 md:px-12 lg:px-24 relative">
        ...
        <div className="max-w-7xl mx-auto">
          <ViewportReveal className="flex justify-between items-end mb-16">
            <div>
              <h2 className="reveal-text text-5xl md:text-7xl font-bold mb-4">
                Recent Work
              </h2>
              <p className="reveal-text text-xl text-gray-400">
            ...
            {[
              {
                phase: 'Discover',
                description:
                  'Understanding your vision, goals, and challenges through research and strategy.',
                steps: ['Research', 'Strategy', 'Planning'],
              },
              {
                phase: 'Design',
                description:
                  'Creating beautiful, functional designs that resonate with your audience.',
                steps: ['Wireframing', 'UI Design', 'Prototyping'],
              },
              {
                phase: 'Develop',
                description:
                  'Building robust, scalable solutions with clean code and best practices.',
                steps: ['Frontend', 'Backend', 'Testing'],
              },
              {
                phase: 'Deploy',
                description:
                  'Launching your project and ensuring long-term success with support.',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              {
                quote:
                  'Their creative approach and technical expertise helped us achieve a 300% increase in conversions.',
